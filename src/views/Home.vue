<script setup>
  import PopularDrinks from '../composants/PopularDrinks.vue'
    ...
    <div class="corps">
      <section class="header">
        <div class="title-wrapper">
          ...
          <span class="top-title">Cocktails for everyone</span>
          <span class="bottom-title">Alcohol abuse is dangerous for health</span>
          </div>
      </section><br><br><br><br>
    </div>
      <div class="title-wrapper">
        <h1 class="sweet-title">
          <span data-text="Popular">Popular</span>
          <span data-text="Cocktails">Cocktails</span><br>
        </h1>
      </div>
    <PopularDrinks />
    <section class="disclaimer">
      <span>Inspired by <a href="https://www.thecocktaildb.com/api.php"><span class="hover:text-blue-200">TheCocktailDB'API</span></a></span>
    </section>
  </div>
</template>
